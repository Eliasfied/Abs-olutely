export const defaultExercises = [
  {
    ...
    difficulty: 3,
    description:
      "Legen Sie sich flach auf den Bauch und stützen Sie Ihren Körper auf Ihren Unterarmen, während Ihre Ellenbogen direkt unter den Schultern positioniert sind. Heben Sie Ihren Körper an, indem Sie Ihre Zehen auf den Boden legen und Ihren Körper in eine gerade Linie bringen. Spannen Sie dabei Ihre Bauchmuskeln und Ihren Po an.",
    muscleGroup: "core",
    number: "9.",
  },
  {
    ...
    difficulty: 3,
    description:
      "Legen Sie sich flach auf den Rücken und ziehen sie die Beine im 90 Grad Winkel an und verschränken sie die Hände hinter dem Kopf. Heben Sie Kopf und Schultern vom Boden ab, während Sie die Bauchmuskeln anspannen und das Kinn leicht zur Brust ziehen. Atmen Sie aus, während Sie sich krümmen, und halten Sie diese Position kurz, bevor Sie langsam wieder in die Ausgangsposition zurückkehren.",
  ...
  },
  {
    ...
    difficulty: 3,
    description:
      "Setzen Sie sich mit ausgestreckten Beinen auf den Boden und strecken Sie die Arme nach vorne aus. Heben Sie den Oberkörper an und bringen Sie gleichzeitig die Hände zu den Zehen, indem Sie Ihre Bauchmuskeln anspannen. Halten Sie diese Position kurz, bevor Sie langsam wieder in die Ausgangsposition zurückkehren.",
    muscleGroup: "core",
    number: "4.",
  },
  {
    ...
    difficulty: 3,
    description:
      "Setzen Sie sich auf den Boden und strecken sie beide Beine aus und halten sie diese über dem Boden. Bringen Sie Ihren Oberkörper ein Stück nach oben und halten sie diese Position.",
    muscleGroup: "core",
    reorderID: 0,
    number: "6.",
  },
  ...
  },
  {
    ...
    difficulty: 3,
    description:
      "Legen sie sich auf den Rücken. Beugen Sie die Knie und heben Sie die Beine an, sodass Ihre Schienbeine parallel zum Boden sind. Nun drücken Sie Ihr Gesäß gerade nach oben und ziehen diesen langsam wieder zurück. Wiederholen Sie diese Bewegung.",
    muscleGroup: "core",
    number: "10.",
  },
  {
  ...
  },
  {
    ...
    difficulty: 3,
    description:
      "Setzen Sie sich auf den Boden, ziehen Sie die Beine zum Körper und halten lehnen Sie sich auf ihre Hände. Stecken Sie nun die Beine aus ohne dass diese den Boden berühren und bringen Sie ihren Unterkörper zum Boden und lehnen Sie sich auf ihre Ellenbogen.",
    muscleGroup: "upper-abs",
    number: "7.",
  },
  {
